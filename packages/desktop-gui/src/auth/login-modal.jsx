...
import { faCheck, faLock, faSyncAlt, faWifi } from '@fortawesome/free-solid-svg-icons'
...
class LoginContent extends Component {
  ...
  render () {
    ...
    return (
      <div className='modal-body login'>
        <BootstrapModal.Dismiss className='btn btn-link close'>x</BootstrapModal.Dismiss>
        <h1><FontAwesomeIcon icon={faLock} /> Log In</h1>
  ...
  _renderSuccess () {
    return (
      <div className='modal-body login'>
        <BootstrapModal.Dismiss className='btn btn-link close'>x</BootstrapModal.Dismiss>
        <h1><FontAwesomeIcon icon={faCheck} /> Login Successful</h1>
